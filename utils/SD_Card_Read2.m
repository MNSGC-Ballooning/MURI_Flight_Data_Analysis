...
output.pressure_ms5611 = umn_I2C_pressure';
output.pressure_analog = umn_ana_pressure';
output.lat = erau_lat;
output.lon = erau_lon;
output.alt = erau_alt;
output.erau_gps_time = erau_gpstime;
output.erau_time = erau_time;
output.umn_time = umn_time;
output.temp1 = erau_temp1;
output.temp2 = erau_temp2;
output.temp3 = erau_temp3;
output.state.erau = cast(erau_STATE,'double');
output.state.cdu1 = cast(cdu1_STATE,'double');
output.state.cdu2 = cast(cdu2_STATE,'double');
